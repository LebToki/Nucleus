...
<body>
    ...
    <section class="auth bg-base d-flex flex-wrap">
        ...
        <div class="auth-left d-lg-block d-none p-0 overflow-hidden">
            <img src="{{ asset('assets/images/auth/auth-img.png') }}" alt="Auth Background" class="w-100 h-100"
                        ...
                        <div class="d-flex justify-content-between gap-2">
                            <div class="form-check style-check d-flex align-items-center">
                                <input class="form-check-input border border-neutral-300" type="checkbox"
                                    name="remember" value="1" id="remeber">
                                <label class="form-check-label" for="remeber">Remember me </label>
                            </div>
                            <a href="{{ route('forgotPassword') }}" class="text-primary-600 fw-medium">Forgot
                                Password?</a>
                        </div>
                    </div>
    ...
    @include('components.script', ['script' => $script ?? ''])
