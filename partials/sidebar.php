<?php
/**
 * Nucleus Sidebar Navigation
 * Version: 2.0.0 — Linux adaptation
...
<aside class="sidebar">
    ...
    <div>
        <a href="index.php" class="sidebar-logo">
            <img src="<?php echo $assetsImageUrl; ?>/logo.png" alt="Nucleus" class="light-logo">
            <img src="<?php echo $assetsImageUrl; ?>/logo-light.png" alt="Nucleus" class="dark-logo">
            <img src="<?php echo $assetsImageUrl; ?>/logo-icon.png" alt="Nucleus" class="logo-icon">
        </a>
    </div>
